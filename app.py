...
# from tools import get_stock_metrics
...
# st.set_page_config(page_title="Quant AI Analyst", layout="wide")

# st.title("📊 Intelligent Quant Analyst")
# st.markdown("AI-powered stock risk analysis")
...
#         fig = px.bar(df, x="Ticker", y="Risk Score", color="Risk Score",
...
#             fig = go.Figure()
#             fig.add_trace(go.Scatter(x=df_price.index, y=df_price["Close"], name=ticker))
...
# 🎨 UI Styling
# =========================
st.set_page_config(page_title="Quant AI Analyst Pro", layout="wide")
...
if st.button("Analyze"):
    ...
    if tickers:
        ...
        for ticker in ticker_list:
            ...
            # store result to avoid duplicate API calls
